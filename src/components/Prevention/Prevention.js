    ...
    <div>
      <header className="prevention__header">
        ...
        <div className="prevention__hero">
          <div className="prevention__first">Wear A Mask </div>
          <div className="prevention__second">Save Lives </div>
      ...
      <section className="symptoms__section">
        <div className="symptoms__title">
          <h2>
            ...
            Prevention <img src={preventionIcon} className="prev" />
          </h2>
        </div>
